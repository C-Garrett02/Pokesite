...
async function GetVariationData(variety) { //Currently does not differentiate between purely cosmetic forms (e.g. polteageist antique vs phony, alcremie, etc)
    ...
    if(body.forms.length == 1){ //Currently avoiding multiple forms per one variety. Name stays as placeholder otherwise, which will then signal GetFormDetails to give this form the species name.
